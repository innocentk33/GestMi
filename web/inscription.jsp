...
<div class="register-photo">
    <div class="form-container">
        ...
        <form action="inscription" method="post">
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit">S'enregistrer</button></div><a href="<c:url value="/connexion"></c:url> " class="already">Vous avez deja un compte? connectez-vous ici</a></form>
    </div>
</div>
